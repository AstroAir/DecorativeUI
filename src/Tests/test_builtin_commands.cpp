...
private slots:
    ...
    void testBuiltinCommandRegistration() {
        ...
        QVERIFY(registered_commands.contains("save_file"));
        QVERIFY(registered_commands.contains("load_file"));
        QVERIFY(registered_commands.contains("clipboard.copy"));
        QVERIFY(registered_commands.contains("clipboard.paste"));
        QVERIFY(registered_commands.contains("show_message"));
    }
