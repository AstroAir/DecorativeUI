...
private slots:
    ...
    void testJSONParserMaxDepth() {
        ...
        try {
            ...
            QVERIFY(e.getMessage().contains("depth") ||
    ...
    void testJSONValidatorCustomRules() {
        ...
        validator.addCustomRule(
            "positive_number", [](const QJsonValue& value) -> bool {
        ...
        // This test depends on how custom rules are applied in the
    ...
    void testComponentRegistryBasicRegistration() {
        ...
        registry.registerComponent(
            "Button", [](const QJsonObject& config) -> QWidget* {
    ...
    void testComponentRegistryComponentCreation() {
        ...
        registry.registerComponent(
            "Label", [](const QJsonObject& config) -> QWidget* {
    ...
    void testComponentRegistryUnregistration() {
        ...
        registry.registerComponent(
            "TempComponent",
            [](const QJsonObject&) -> QWidget* { return new QWidget(); });
