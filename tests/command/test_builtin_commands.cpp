...
private slots:
    ...
    void testBuiltinCommandRegistration() {
        ...
        QVERIFY(std::find(registered_commands.begin(),
                          registered_commands.end(),
                          "set_property") != registered_commands.end());
        QVERIFY(std::find(registered_commands.begin(),
                          registered_commands.end(),
                          "update_state") != registered_commands.end());
        QVERIFY(std::find(registered_commands.begin(),
                          registered_commands.end(),
                          "save_file") != registered_commands.end());
        QVERIFY(std::find(registered_commands.begin(),
                          registered_commands.end(),
                          "load_file") != registered_commands.end());
        QVERIFY(std::find(registered_commands.begin(),
                          registered_commands.end(),
                          "clipboard.copy") != registered_commands.end());
        QVERIFY(std::find(registered_commands.begin(),
                          registered_commands.end(),
                          "clipboard.paste") != registered_commands.end());
        QVERIFY(std::find(registered_commands.begin(),
                          registered_commands.end(),
                          "show_message") != registered_commands.end());
    }
