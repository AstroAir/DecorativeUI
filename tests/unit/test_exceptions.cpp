...
private slots:
    ...
    void testComponentCreationException() {
        ...
        QVERIFY(exception.getMessage().find("Failed to create component") !=
                std::string::npos);
        QVERIFY(exception.getContext().find("Button") != std::string::npos);
    }

    void testComponentCreationExceptionWithReason() {
        ComponentCreationException exception("Label",
                                             "Memory allocation failed");

        QCOMPARE(exception.getComponentType(), std::string("Label"));
        QVERIFY(exception.getMessage().find("Memory allocation failed") !=
                std::string::npos);
    }
    ...
    void testComponentRegistrationException() {
        ...
        QVERIFY(exception.getMessage().find("Component registration failed") !=
                std::string::npos);
    }
    ...
    void testComponentRegistrationExceptionWithReason() {
        ...
        QCOMPARE(exception.getComponentName(), std::string("CustomWidget"));
        QVERIFY(exception.getMessage().find("Duplicate registration") !=
                std::string::npos);
    }
    ...
    void testPropertyBindingException() {
        ...
        QVERIFY(exception.getMessage().find("Property binding failed") !=
                std::string::npos);
    }

    void testStateManagementException() {
        StateManagementException exception("user_state",
                                           "Invalid state transition");

        QCOMPARE(exception.getStateKey(), std::string("user_state"));
        QVERIFY(exception.getMessage().find("Invalid state transition") !=
                std::string::npos);
    }
    ...
    void testLayoutException() {
        ...
        QVERIFY(exception.getMessage().find("Invalid layout configuration") !=
                std::string::npos);
    }
    ...
    void testLayoutExceptionWithType() {
        ...
        QVERIFY(exception.getMessage().find("Cannot add widget to layout") !=
                std::string::npos);
    }
    ...
    void testJSONParsingException() {
        ...
        QVERIFY(exception.getMessage().find("Unexpected token") !=
                std::string::npos);
    ...
    void testJSONValidationException() {
        ...
        QVERIFY(exception.getMessage().find("Required field missing") !=
                std::string::npos);
    ...
    void testJSONValidationExceptionWithPath() {
        ...
        QVERIFY(exception.getMessage().find("Type mismatch") !=
                std::string::npos);
    }

    void testJSONValidationExceptionMultipleErrors() {
        std::vector<std::string> errors = {"Missing required field 'name'",
        ...
        QCOMPARE(validation_errors[0],
                 std::string("Missing required field 'name'"));
        QCOMPARE(validation_errors[1],
                 std::string("Invalid type for field 'value'"));
        QCOMPARE(validation_errors[2], std::string("Unknown property 'extra'"));

        std::string what_msg = exception.what();
        QVERIFY(what_msg.find("1. Missing required field 'name'") !=
                std::string::npos);
        QVERIFY(what_msg.find("2. Invalid type for field 'value'") !=
                std::string::npos);
        QVERIFY(what_msg.find("3. Unknown property 'extra'") !=
                std::string::npos);
    }
    ...
    void testHotReloadException() {
        ...
        QVERIFY(exception.getMessage().find("Reload failed") !=
                std::string::npos);
    }
    ...
    void testHotReloadExceptionWithFile() {
        ...
        QVERIFY(exception.getMessage().find("File not found") !=
                std::string::npos);
    }
    ...
    void testFileWatchException() {
        ...
        QVERIFY(exception.getMessage().find("Permission denied") !=
                std::string::npos);
    }
    ...
    void testNetworkException() {
        NetworkException exception("https://api.example.com",
                                   "Connection timeout");

        QCOMPARE(exception.getUrl(), std::string("https://api.example.com"));
        QVERIFY(exception.getMessage().find("Connection timeout") !=
                std::string::npos);
    ...
    void testStyleException() {
        ...
        QVERIFY(exception.getMessage().find("Invalid CSS property") !=
                std::string::npos);
    }
    ...
    void testEventHandlingException() {
        ...
        QVERIFY(exception.getMessage().find("Handler not found") !=
                std::string::npos);
    }
    ...
    void testConfigurationException() {
        ...
        QVERIFY(exception.getMessage().find("Invalid color value") !=
                std::string::npos);
    }

    void testInitializationException() {
        InitializationException exception("DatabaseConnection",
                                          "Connection failed");

        QCOMPARE(exception.getComponentName(),
                 std::string("DatabaseConnection"));
        QVERIFY(exception.getMessage().find("Connection failed") !=
                std::string::npos);
    }
    ...
    void testRuntimeException() {
        ...
        QVERIFY(exception.getMessage().find("Null pointer access") !=
                std::string::npos);
    }
    ...
    void testConcurrencyException() {
        ...
        QVERIFY(exception.getMessage().find("Deadlock detected") !=
                std::string::npos);
    }
    ...
    void testExceptionChain() {
        ...
        auto tertiary = std::make_unique<ComponentCreationException>(
        ...
        QVERIFY(
            what_msg.find("2. Failed to create component: Creation failed") !=
            std::string::npos);
    }
    ...
    void testCreateException() {
        auto exception =
            createException<ComponentCreationException>("TestWidget");
    ...
    void testSafeExecute() {
        ...
        auto result = safeExecute<int>([]() -> int { return 42; });
        ...
        auto error_result = safeExecute<int>(
            []() -> int { throw UIException("Test error"); },
        ...
        auto std_error_result = safeExecute<int>(
            []() -> int { throw std::runtime_error("Standard error"); },
            [&std_error_handled](const UIException& e) {
                std_error_handled = true;
                QVERIFY(e.getMessage().find("Unexpected exception") !=
                        std::string::npos);
            });
    ...
    void testExceptionMacros() {
        ...
        try {
            THROW_UI_EXCEPTION_WITH_CONTEXT(UIException, "test context",
                                            "Test message");
            QFAIL("Exception should have been thrown");
        ...
        try {
            THROW_UI_EXCEPTION_WITH_SUGGESTION(UIException, "try this",
                                               "Test message");
            QFAIL("Exception should have been thrown");
        } catch (const UIException& e) {
            QCOMPARE(e.getMessage(), std::string("Test message"));
    ...
    void testExceptionInheritance() {
        ...
        try {
            ...
            QVERIFY(e.getMessage().find("Failed to create component") !=
                    std::string::npos);
        }
