...
private slots:
    ...
    void testUIElementEventHandling() {
        ...
        element->onEvent("test_event",
                         [&event_triggered]() { event_triggered = true; });
    ...
    void testDeclarativeBuilderPropertyBinding() {
        ...
        auto widget = create<QLabel>()
                          .bind("text",
                                [&counter]() -> PropertyValue {
                                    return PropertyValue(
                                        QString("Count: %1").arg(++counter));
                                })
                          .build();
    ...
    void testDeclarativeBuilderComplexLayout() {
            ...
            create<QWidget>()
                ...
                .child<QWidget>([](DeclarativeBuilder<QWidget>& container) {
                    container.template layout<QHBoxLayout>()
                        .template child<QLineEdit>(
                            [](DeclarativeBuilder<QLineEdit>& edit) {
                                edit.property("placeholderText",
                                              QString("Enter text"));
                            })
                        .template child<QPushButton>(
                            [](DeclarativeBuilder<QPushButton>& button) {
        ...
        auto* container =
            qobject_cast<QWidget*>(main_layout->itemAt(1)->widget());
        ...
        auto* line_edit =
            qobject_cast<QLineEdit*>(h_layout->itemAt(0)->widget());
        auto* button =
            qobject_cast<QPushButton*>(h_layout->itemAt(1)->widget());
    ...
    void testCreateFactoryFunction() {
        ...
        auto widget = builder.property("text", QString("Factory Test")).build();
    ...
    void testCreateWithDifferentWidgetTypes() {
        ...
        auto label =
            create<QLabel>().property("text", QString("Label")).build();

        auto button =
            create<QPushButton>().property("text", QString("Button")).build();

        auto line_edit =
            create<QLineEdit>().property("text", QString("LineEdit")).build();
    ...
    void testBuilderExceptionHandling() {
        ...
        try {
            ...
            QFAIL(QString("Builder threw unexpected exception: %1")
                      .arg(e.what())
                      .toLocal8Bit());
        }
    }
    ...
    void testUIElementExceptionHandling() {
        ...
        try {
            ...
            element->bindProperty("test", []() -> PropertyValue {
                return PropertyValue(QString("test"));
            });
            element->initialize();
            element->refresh();
            element->invalidate();
            ...
            QFAIL(QString("UIElement threw unexpected exception: %1")
                      .arg(e.what())
                      .toLocal8Bit());
        }
    }
