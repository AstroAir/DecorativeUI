...
void AccessibilityTest::testAccessibilityManagerSingleton() {
    Accessibility::AccessibilityManager& manager1 =
        Accessibility::AccessibilityManager::instance();
    Accessibility::AccessibilityManager& manager2 =
        Accessibility::AccessibilityManager::instance();
...
void AccessibilityTest::testComponentRegistration() {
    ...
    QCOMPARE(retrievedProps->description,
             QString("Widget for testing accessibility"));
...
void AccessibilityTest::testAccessibilityBuilder() {
    ...
    auto props = builder.name("Test Button")
