...
public:
    ...
    static std::unique_ptr<NavigationBar> createNavigationBar(QWidget* parent = nullptr);
    static std::unique_ptr<StatusIndicator> createStatusIndicator(QWidget* parent = nullptr);
    static std::unique_ptr<SearchBox> createSearchBox(QWidget* parent = nullptr);
    static std::unique_ptr<DataTable> createDataTable(QWidget* parent = nullptr);
    ...
    static QIcon createColoredIcon(const QString& icon_name, const QColor& color);
    
    // Theme utilities
    static void applyLightTheme(QWidget* widget);
    static void applyDarkTheme(QWidget* widget);
    static void applyCustomTheme(QWidget* widget, const QColor& primary, const QColor& secondary);
