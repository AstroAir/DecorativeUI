 ...
 * 
 * This application demonstrates all features and capabilities of the DeclarativeUI
 * framework in a single, interactive showcase. It serves as both a learning
 * resource and a reference implementation for best practices.
 * 
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        qDebug() << "💡 Explore all DeclarativeUI features in the interactive showcase!";
        qDebug() << "";
        ...
        QMessageBox::critical(
            nullptr,
            "DeclarativeUI Showcase Error",
            QString("An error occurred while starting the application:\n\n%1\n\n"
