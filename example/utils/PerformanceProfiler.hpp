...
struct PerformanceMetric {
    ...
    PerformanceMetric(const QString& n, qint64 v, const QString& u, const QString& c = "general")
        : name(n), value(v), unit(u), timestamp(QDateTime::currentDateTime()), category(c) {}
};
...
public:
    ...
    // Metric recording
    void recordMetric(const QString& name, qint64 value, const QString& unit = "ms");
