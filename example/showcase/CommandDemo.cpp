...
void CommandDemo::createCommandHistory() {
    ...
    auto description = new QLabel(
        "This demo shows the DeclarativeUI command system with undo/redo "
        "functionality. "
        "Commands are executed, tracked, and can be undone or redone as "
        "needed.");
...
void CommandDemo::updateHistoryDisplay() {
    ...
    history_group_->setTitle(
        QString("Command History & Results - %1").arg(status));
}
