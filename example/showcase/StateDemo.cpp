...
void StateDemo::setupUI() {
    ...
    // Connect signals
    connect(counter_button, &QPushButton::clicked, this,
            &StateDemo::onStateChanged);
    connect(reset_button, &QPushButton::clicked, this,
            &StateDemo::onResetState);
...
void StateDemo::setupStateBindings() {
    ...
    state_manager_->setState("demo.timestamp",
...
void StateDemo::updateDisplay() {
    ...
    display_text +=
        QString("Last Updated: %1\n")
            .arg(state_manager_->getState("demo.timestamp", QString(""))
                     .toString());
    display_text += "\n";
