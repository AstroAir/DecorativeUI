...
private:
    void setupStateManager() {
        ...
        stateManager.setState("form.message",
                              QString("Welcome to Command-based UI!"));
    ...
    void setupUI() {
        try {
            ...
            auto mainUI = UI::
                              CommandHierarchyBuilder("Container")
                                  ...
                                  .addContainer(
                                      "Container",
                                      [this](
                                          UI::CommandHierarchyBuilder& header) {
                                          header.layout("HBox")
                                              .spacing(15)
                                              .style(
                                  ...
                                  .addContainer("Container",
                                                [this](
                                                    ...
                                                    contentArea.layout("HBox")
                                                                        ...
                                                                        [this](
                                                                            ...
                                                                            counterSection
                                                                                ...
                                                                                .spacing(
                                                                                    10)
                                                                                .style(
                                                                                    "border: 2px solid #e74c3c; border-radius: 8px; padding: 15px; background-color: #fdf2f2;")
                                                                                .addChild(
                                                                                    "Label",
                                                                                    [](UI::CommandBuilder&
                                                                                           counterTitle) {
                                                                                    ...
                                                                                    [](UI::CommandBuilder&
                                                                                        ...
                                                                                        counterDisplay
                                                                                            .text(
                                                                                                "Count: 0")
                                                                                            .style(
                                                                                                "font-size: 32px; color: #2c3e50; text-align: center; font-weight: bold;")
                                                                                            .bindToState(
                                                                                                "counter.display",
                                                                                                "text");
                                                                                    })
                                                                                                ...
                                                                                                [this](
                                                                                                    ...
                                                                                                    minusBtn
                                                                                                        .text(
                                                                                                            "➖")
                                                                                                        .style(
                                                                                                            "background-color: #e74c3c; color: white; padding: 10px; border-radius: 5px; font-size: 18px; min-width: 50px;")
                                                                                                        .onClick([this]() {
                                                                                                            modifyCounter(
                                                                                                                -1);
                                                                                                        });
                                                                                                ...
                                                                                                [this](
                                                                                                    ...
                                                                                                    resetBtn
                                                                                                        .text(
                                                                                                            "🔄")
                                                                                                        .style(
                                                                                                            "background-color: #f39c12; color: white; padding: 10px; border-radius: 5px; font-size: 18px; min-width: 50px;")
                                                                                                        .onClick(
                                                                                                            [this]() {
                                                                                                                resetCounter();
                                                                                                            });
                                                                                                ...
                                                                                                [this](
                                                                                                    ...
                                                                                                    plusBtn
                                                                                                        .text(
                                                                                                            "➕")
                                                                                                        .style(
                                                                                                            "background-color: #27ae60; color: white; padding: 10px; border-radius: 5px; font-size: 18px; min-width: 50px;")
                                                                                                        .onClick(
                                                                                                            [this]() {
                                                                                                                modifyCounter(
                                                                                                                    1);
                                                                        ...
                                                                        [this](
                                                                            ...
                                                                            inputSection
                                                                                ...
                                                                                .spacing(
                                                                                    10)
                                                                                .style(
                                                                                    "border: 2px solid #3498db; border-radius: 8px; padding: 15px; background-color: #f8fbff;")
                                                                                .addChild(
                                                                                    "Label",
                                                                                    [](UI::CommandBuilder&
                                                                                           inputTitle) {
                                                                                    ...
                                                                                    [this](
                                                                                        ...
                                                                                        nameInput
                                                                                            .placeholder(
                                                                                                "Enter your name...")
                                                                                            .style(
                                                                                                "padding: 12px; border: 2px solid #bdc3c7; border-radius: 5px; font-size: 14px;")
                                                                                            .bindToState(
                                                                                                "user.name",
                                                                                                "text")
                                                                                            .onTextChanged(
                                                                                ...
                                                                                .addChild(
                                                                                    ...
                                                                                    [](UI::CommandBuilder&
                                                                                        ...
                                                                                        greeting
                                                                                            ...
                                                                                            .style(
                                                                                                "font-size: 14px; color: #7f8c8d; font-style: italic; margin-top: 8px; padding: 8px; background-color: #ecf0f1; border-radius: 3px;")
                                                                                            .bindToState(
                                                                                                "form.message",
                                                                                                "text");
                                                                                    });
                                                                                    ...
                                                                                    [this](
                                                                                        ...
                                                                                        randomBtn
                                                                                            .text(
                                                                                                "🎲 Random Action")
                                                                                            .style(
                                                                                                "background-color: #9b59b6; color: white; padding: 12px; border-radius: 5px; font-weight: bold;")
                                                                                            .onClick(
                                                                                                [this]() {
                                                                                                    performRandomAction();
                                                                                                });
                                                                                    ...
                                                                                    [this](
                                                                                        ...
                                                                                        clearBtn
                                                                                            .text(
                                                                                                "🧹 Clear All")
                                                                                            .style(
                                                                                                "background-color: #95a5a6; color: white; padding: 12px; border-radius: 5px; font-weight: bold;")
                                                                                            .onClick(
                                                                                                [this]() {
                                                                                                    clearAll();
                                                                                                });
                                                        ...
                                                        .addContainer(
                                                            "Container", [this](
                                                                             UI::CommandHierarchyBuilder& rightPanel) {
                                                                rightPanel
                                                                    .layout(
                                                                        "VBox")
                                                                    .spacing(15)
                                                                                ...
                                                                                .addChild(
                                                                                    ...
                                                                                    [](UI::CommandBuilder&
                                                                                        ...
                                                                                        info1
                                                                                            ...
                                                                                            .style(
                                                                                                "font-size: 14px; color: #27ae60; padding: 5px;");
                                                                                    })
                                                                                .addChild(
                                                                                    "Label",
                                                                                    [](UI::CommandBuilder&
                                                                        ...
                                                                        [](UI::CommandHierarchyBuilder&
                                                                            ...
                                                                            statusArea
                                                                                ...
                                                                                .spacing(
                                                                                    10)
                                                                                .style(
                                                                                    "background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin-top: 20px;")
                                                                                .addChild(
                                                                                    "Label",
                                                                                    [](UI::CommandBuilder&
                                                                                           statusTitle) {
                                                                                        statusTitle
                                                                                            .text(
                                                                                                "🔄 Live Status")
                                                                                            .style(
                                                                                                "font-size: 16px; font-weight: bold; color: #495057;");
                                                                                    })
                                                                                .addChild(
                                                                                    "Label",
                                                                                    [](UI::CommandBuilder&
                                                                                        ...
                                                                                        status
                                                                                            .text(
                                                                                                "System Ready")
                                                                                            .style(
                                                                                                "font-size: 14px; color: #6c757d; font-family: monospace;")
                                                                                            .bindToState(
                                                                                                "system.status",
                                                                                                "text");
                                                                                    });
                                  ...
                                  .addContainer(
                                      "Container",
                                      [](UI::CommandHierarchyBuilder& footer) {
                                          footer.layout("HBox")
                                              .spacing(10)
                                              .style(
            ...
            auto widget =
                UI::WidgetMapper::instance().createWidget(mainUI.get());
            if (widget) {
    ...
    void setupStateMonitoring() {
        ...
        connect(&stateManager,
                &DeclarativeUI::Binding::StateManager::stateChanged, this,
    ...
    void setupDemoTimer() {
        ...
        connect(demo_timer_, &QTimer::timeout, this,
                &CommandUIBuilderExample::demoStep);
    }
    ...
    void modifyCounter(int delta) {
        ...
        updateSystemStatus(QString("Counter %1 to %2")
                               .arg(delta > 0 ? "incremented" : "decremented")
                               .arg(newValue));
    ...
    void updateGreeting(const QString& name) {
        ...
        updateSystemStatus(QString("Greeting updated for: %1")
                               .arg(name.isEmpty() ? "anonymous" : name));
    }
    ...
    void toggleTheme() {
        ...
        setStyleSheet(
            QString("QMainWindow { background-color: %1; }").arg(bgColor));
    ...
    void clearAll() {
        ...
        stateManager.setState("user.name", QString(""));
        stateManager.setState("form.message",
                              QString("All cleared - ready for new input"));
        stateManager.setState("theme.current", QString("light"));
