...
private:
    ...
    void setupMainContent(QVBoxLayout *mainLayout) {
        ...
        contentLabel->setStyleSheet(
            "border: 1px solid gray; padding: 20px; margin: 10px;");
    ...
    void setupMenus() {
        ...
        connect(newAction, &QAction::triggered, this,
                &ApplicationMainWindow::onNewAction);

        auto openAction = fileMenu->addAction("&Open");
        openAction->setShortcut(QKeySequence::Open);
        connect(openAction, &QAction::triggered, this,
                &ApplicationMainWindow::onOpenAction);

        auto saveAction = fileMenu->addAction("&Save");
        saveAction->setShortcut(QKeySequence::Save);
        connect(saveAction, &QAction::triggered, this,
                &ApplicationMainWindow::onSaveAction);
        ...
        connect(exitAction, &QAction::triggered, this,
                &ApplicationMainWindow::onExitAction);
        ...
        connect(aboutAction, &QAction::triggered, this,
                &ApplicationMainWindow::onAboutAction);
    }
