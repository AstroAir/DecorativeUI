...
#include "../state-integration/IntegrationExample.hpp"
...
int main(int argc, char* argv[]) {
    ...
    qDebug() << "This example demonstrates integration between legacy "
                "Components and new Commands";
    ...
    try {
        ...
        [[maybe_unused]] auto& integrationManager =
            DeclarativeUI::Command::Adapters::IntegrationManager::instance();
