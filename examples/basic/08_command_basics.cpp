...
private:
    void setupUI() {
        ...
        connect(decrementBtn, &QPushButton::clicked, this, &CommandBasicsExample::decrement);
        connect(resetBtn, &QPushButton::clicked, this, &CommandBasicsExample::reset);
        connect(incrementBtn, &QPushButton::clicked, this, &CommandBasicsExample::increment);
